...
function AnswerSvgButton(props: IAnswerSvgButtonProps) {
  const {
    title,
    order,
    idx,
  ...
  return (
    ...
    >
      ...
      >
        <path className={getPathClass()} d="M388 36L405 36" />
        <path className={getPathClass()} d="M0 36L17 36" />
        <path
...
export default AnswerSvgButton;
